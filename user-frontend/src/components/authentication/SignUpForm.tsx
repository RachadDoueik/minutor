    ...
    <CursorDepthBackground className="flex min-h-screen flex-col items-center justify-center bg-gray-50 px-6 py-12">
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="mt-1 text-gray-700">Sign up with your email</p>
        </div>

        {/* Sign up with */}
        <DividerWithText>Sign up with</DividerWithText>
        ...
        <InputField
          ...
          <p className="flex text-center mx-auto mt-1.5 text-sm text-gray-500">
        ...
        <p className="mt-8 text-center text-sm text-gray-500">
          ...
          <a href="/terms" className="text-gray-600 underline hover:underline">Terms &amp; Conditions</a>
          {' '}and{' '}
          <a href="/privacy" className="text-gray-600 underline hover:underline">Privacy Policy</a>
        </p>
      </div>
